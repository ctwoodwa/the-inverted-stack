...
| Ch 16 | `chapters/part-3-reference-architecture/ch16-persistence-beyond-the-node.md` | icm/prose-review | 3,556 | ~3,500 | ✓ |
| Ch 17 | `chapters/part-4-implementation-playbooks/ch17-building-first-node.md` | icm/prose-review | 3,910 | ~4,000 | ✓ |
| Ch 18 | `chapters/part-4-implementation-playbooks/ch18-migrating-existing-saas.md` | icm/prose-review | 3,286 | ~3,500 | ✓ |
| Ch 19 | `chapters/part-4-implementation-playbooks/ch19-shipping-to-enterprise.md` | icm/prose-review | 3,481 | ~3,500 | ✓ |
| Ch 20 | `chapters/part-4-implementation-playbooks/ch20-ux-sync-conflict.md` | icm/prose-review | 2,934 | ~3,000 | ✓ |
| Epilogue | `chapters/epilogue/epilogue-what-the-stack-owes-you.md` | icm/prose-review | 2,488 | ~2,500 | ✓ |
...
**Running total (excluding foreword/placeholder):** ~81,900 words
**Target:** ~83,500 words
**Gap:** ~1,600 words — preface requires author expansion (~374 words) + foreword placeholder

## Next Steps

1. **icm/voice-check** (author, all chapters): personal anecdotes, field stories, consistent authorial voice
2. **Preface expansion** (author): 926 words currently; ~374 words needed to reach 1,300-word target — human-only
3. **Foreword**: external contributor needed
4. **Final assembly**: set all chapters to `icm/assembled` and run `make draft-pdf`
